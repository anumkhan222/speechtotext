...
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://anumkh256_db_user:sc07TzF0ueLiLqr8@cluster0.whlcuvr.mongodb.net/")
MONGO_DB_NAME = os.getenv("MONGO_DB_NAME", "speechtext")